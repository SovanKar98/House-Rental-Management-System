...
function invoices_validateData(){
	...
	if($j('#total').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Total (Rs)", close: function(){ /* */ $j('[name=total]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field status can't be empty */
...
function payments_validateData(){
	...
	if($j('#paid_amount').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Paid amount (Rs)", close: function(){ /* */ $j('[name=paid_amount]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
