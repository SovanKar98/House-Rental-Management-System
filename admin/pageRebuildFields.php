	...
	*/
	...
	$schema = array(   
		'houses' => array(   
			...
			'house_number' => array('appgini' => 'VARCHAR(40) not null '),
			'features' => array('appgini' => 'TEXT not null '),
			'rent' => array('appgini' => 'VARCHAR(40) not null '),
		...
		'tenants' => array(   
			...
			'registration_date' => array('appgini' => 'DATE not null '),
			'house' => array('appgini' => 'INT unsigned not null '),
			'agreement_document' => array('appgini' => 'VARCHAR(100) '),
			'status' => array('appgini' => 'VARCHAR(40) not null '),
			'exit_date' => array('appgini' => 'DATE ')
		),
		'invoices' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'tenant' => array('appgini' => 'INT unsigned not null '),
			'phone' => array('appgini' => 'INT unsigned '),
			'house' => array('appgini' => 'INT unsigned '),
			'year' => array('appgini' => 'VARCHAR(40) not null '),
			'month' => array('appgini' => 'VARCHAR(40) not null '),
			'particulars' => array('appgini' => 'TEXT not null '),
			'total' => array('appgini' => 'VARCHAR(40) not null '),
			'status' => array('appgini' => 'VARCHAR(40) not null '),
		...
		'payments' => array(   
			...
			'tenant' => array('appgini' => 'INT unsigned not null '),
			'house' => array('appgini' => 'INT unsigned '),
			'year' => array('appgini' => 'INT unsigned '),
			'month' => array('appgini' => 'INT unsigned '),
			'expected_amount' => array('appgini' => 'INT unsigned '),
			'paid_amount' => array('appgini' => 'VARCHAR(40) not null '),
			'balance' => array('appgini' => 'VARCHAR(40) '),
